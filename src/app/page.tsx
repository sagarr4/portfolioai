    ...
    <div style={{background:'#0c0a08',color:'#f5f0e8',fontFamily:"'Playfair Display',serif",overflowX:'hidden'}}>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .H1{font-size:clamp(24px, 3.5vw, 40px);font-weight:800;line-height:.9;letter-spacing:-.055em;color:#f5f0e8;max-width:1100px;position:relative;z-index:1;margin-bottom:0}
        ...
        .DH{font-size:clamp(24px, 3.5vw, 40px);font-weight:700;line-height:1.0;letter-spacing:-.045em;color:#f5f0e8}
        ...
        .sn{font-family:'Playfair Display',serif;font-size:80px;font-weight:800;color:rgba(201,169,110,.07);letter-spacing:-.025em;line-height:1;margin-bottom:36px}
      ...
      <div className="FINAL r">
        ...
        <h2 style={{fontSize:'clamp(24px, 3.5vw, 40px)',fontWeight:800,lineHeight:.9,letterSpacing:'-.055em',color:'#f5f0e8',marginBottom:28,position:'relative',zIndex:1}}>
