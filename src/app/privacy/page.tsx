  ...
  return (
    <div className="pai-page" style={{minHeight:'100vh',background:'#0c0a08',color:'#f5f0e8',fontFamily:"'DM Sans',sans-serif",padding:'120px 72px 80px'}}>
      ...
      <div style={{maxWidth:720,margin:'0 auto'}}>
        ...
        <h1 className="pai-page-h1" style={{fontFamily:"'Playfair Display',serif",fontSize:48,fontWeight:700,letterSpacing:'-.04em',marginBottom:12,lineHeight:1}}>Privacy <em style={{fontStyle:'italic',color:'#c9a96e'}}>Policy</em></h1>
